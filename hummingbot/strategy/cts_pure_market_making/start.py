...
from hummingbot.strategy.cts_pure_market_making import (
    CtsPureMarketMakingStrategy,
    InventoryCostPriceDelegate,
)
from hummingbot.strategy.cts_pure_market_making.cts_pure_market_making_config_map import cts_pure_market_making_config_map as c_map
...
def start(self):
    try:
        ...
        strategy_logging_options = CtsPureMarketMakingStrategy.OPTION_LOG_ALL
        self.strategy = CtsPureMarketMakingStrategy()
